...
u.remove = function(a) {
  return fb(this.N, a) ? (delete this.N[a], this.f--, this.bc++, this.j.length > 2 * this.f && eb(this), l) : r
};
function eb(a) {
  if(a.f != a.j.length) {
...
u.set = function(a, b) {
  fb(this.N, a) || (this.f++, this.j.push(a), this.bc++);
  this.N[a] = b
};
u.n = function() {
  return new db(this)
...
;function I(a, b) {
  var c;
  if(a instanceof I) {
    this.C = b !== h ? b : a.C, gb(this, a.pa), c = a.ab, J(this), this.ab = h ? c ? decodeURIComponent(c) : "" : c, hb(this, a.ia), ib(this, a.Aa), jb(this, a.G), kb(this, a.Q.n()), c = a.Ma, J(this), this.Ma = h ? c ? decodeURIComponent(c) : "" : c
  }else {
    if(a && (c = String(a).match(Ra))) {
      ...
      var d = c[2] || "";
      J(this);
      this.ab = l ? d ? decodeURIComponent(d) : "" : d;
      hb(this, c[3] || "", l);
      ib(this, c[4]);
      jb(this, c[5] || "", l);
      kb(this, c[6] || "", l);
      c = c[7] || "";
      J(this);
      this.Ma = l ? c ? decodeURIComponent(c) : "" : c
    }else {
...
xb = new yb;
function P() {
  0 != Cb && (this.Gc = Error().stack, Db[A(this)] = this)
}
var Cb = 0, Db = {};
P.prototype.yb = r;
P.prototype.Ia = function() {
  if(!this.yb && (this.yb = l, this.u(), 0 != Cb)) {
    var a = A(this);
    delete Db[a]
  }
};
...
u.Oa = function(a, b, c, d, f, g) {
  ha(a) ? this.Ib = l : a && a.handleEvent && ha(a.handleEvent) ? this.Ib = r : e(Error("Invalid listener argument"));
  this.V = a;
  this.Ub = b;
  this.src = c;
  this.type = d;
...
u.handleEvent = function(a) {
  return this.Ib ? this.V.call(this.kb || this.src, a) : this.V.handleEvent.call(this.V, a)
};
...
u.Oa = function(a, b) {
  ...
  this.yc = Da ? a.metaKey : a.ctrlKey;
  this.state = a.state;
  this.zb = a;
...
function Lb(a, b, c, d, f) {
  ...
  a: {
    ...
    S[g] || (S[g] = []);
    S[g].push(k);
    a.addEventListener ? (a == w || !a.wb) && a.addEventListener(b, n, d) : a.attachEvent(b in Kb ? Kb[b] : Kb[b] = "on" + b, n);
    a = k
  }
  b = a.key;
  Ta[b] = a;
...
function Pb(a) {
  ...
  c.removeEventListener ? (c == w || !c.wb) && c.removeEventListener(d, f, g) : c.detachEvent && c.detachEvent(d in Kb ? Kb[d] : Kb[d] = "on" + d, f);
  c = A(c);
  if(S[c]) {
    var f = S[c], k = Ya(f, b);
...
function Qb(a, b, c, d) {
  if(!d.Qa && d.Mb) {
    for(var f = 0, g = 0;f < d.length;f++) {
      d[f].da ? d[f].Ub.src = m : (f != g && (d[g] = d[f]), g++)
    }
    d.length = g;
    d.Mb = r;
...
function Sb(a, b, c, d, f) {
  ...
  if(a[b]) {
    ...
    try {
      ...
      a.t = Math.max(k, a.t), q.Qa--, Qb(c, d, b, q)
    }
  }
  return Boolean(g)
}
  ...
  if(b in c) {
    ...
    if(b) {
      ...
      for(var k = f.length - 1;!a.ma && 0 <= k && g.t;k--) {
        a.currentTarget = f[k], d &= Sb(g, f[k], a.type, l, a) && a.Wa != r
      }
    }
    if(r in c) {
      if(g = c[r], g.t = g.f, b) {
        for(k = 0;!a.ma && k < f.length && g.t;k++) {
          a.currentTarget = f[k], d &= Sb(g, f[k], a.type, r, a) && a.Wa != r
        }
      }else {
        for(f = this;!a.ma && f && g.t;f = f.ob) {
          a.currentTarget = f, d &= Sb(g, f, a.type, r, a) && a.Wa != r
        }
      }
    }
    a = Boolean(d)
...
u.Ec = function() {
  if(this.enabled) {
    var a = C() - this.nb;
    0 < a && a < 0.8 * this.ca ? this.r = this.Da.setTimeout(this.eb, this.ca - a) : (this.dispatchEvent(Xb), this.enabled && (this.r = this.Da.setTimeout(this.eb, this.ca), this.nb = C()))
  }
};
u.start = function() {
  this.enabled = l;
  this.r || (this.r = this.Da.setTimeout(this.eb, this.ca), this.nb = C())
};
u.stop = function() {
  this.enabled = r;
...
u.r = m;
u.stop = function() {
  this.r && (Wb.clearTimeout(this.r), this.r = m, this.Xa = r)
};
u.u = function() {
  ac.qa.u.call(this);
  this.stop()
...
u.tc = function() {
  this.r = m;
  this.Xa && !this.Tb && (this.Xa = r, bc(this))
};
function bc(a) {
  var b;
  b = a.hc;
...
function jc(a, b) {
  ...
  sb(a.w, "t", a.Ba);
  a.Ea = 0;
  a.l = a.b.Ha(a.b.Ya() ? b : m);
  0 < a.na && (a.Ta = new ac(B(a.dc, a, a.l), a.na));
  $b(a.ib, a.l, "readystatechange", a.Ac);
  var c;
  if(a.v) {
    c = a.v;
    var d = {}, f;
  ...
  a.W ? (a.sa = "POST", c["Content-Type"] = "application/x-www-form-urlencoded", a.l.send(a.w, a.sa, a.W, c)) : (a.sa = "GET", a.Xb && !F && (c.Connection = "close"), a.l.send(a.w, a.sa, m, c));
  a.b.F(mc);
  if(d = a.W) {
    c = "";
    d = d.split("&");
...
u.Ac = function(a) {
  a = a.target;
  var b = this.Ta;
  b && 3 == U(a) ? (this.a.debug("Throttling readystatechange."), !b.r && !b.Tb ? bc(b) : b.Xa = l) : this.dc(a)
};
u.dc = function(a) {
  try {
    if(a == this.l) {
...
function Gc(a, b) {
  ...
  a.J.write(f);
  a.J.close();
  a.J.parentWindow.m = B(a.wc, a);
  a.J.parentWindow.d = B(a.Sb, a, l);
  a.J.parentWindow.rpcClose = B(a.Sb, a, r);
  ...
  switch(typeof b) {
    ...
    case "object":
      ...
      if(x(b)) {
        ...
        c.push("[");
        for(var f = "", g = 0;g < d;g++) {
          c.push(f), f = b[g], Pc(a, a.Va ? a.Va.call(b, String(g), f) : f, c), f = ","
        }
        c.push("]");
        break
      }
      ...
      d = "";
      for(g in b) {
        Object.prototype.hasOwnProperty.call(b, g) && (f = b[g], "function" != typeof f && (c.push(d), Rc(g, c), c.push(":"), Pc(a, a.Va ? a.Va.call(b, g, f) : f, c), d = ","))
      }
      c.push("}");
      break;
    case "function":
...
u.kc = function(a, b, c) {
  var d = new Yc(a, String(b), this.pc);
  if(c) {
    d.Bb = c;
    var f;
...
u.send = function(a, b, c, d) {
  this.g && e(Error("[goog.net.XhrIo] Object is active with another request=" + this.Pa + "; newUri=" + a));
  ...
  this.R = l;
  this.g = this.vb();
  this.bb = this.ua ? this.ua.Fa || (this.ua.Fa = Bb(this.ua)) : xb.Fa || (xb.Fa = Bb(xb));
  this.g.onreadystatechange = B(this.Ob, this);
  try {
  ...
  try {
    this.ea && (Wb.clearTimeout(this.ea), this.ea = m), 0 < this.$a && (X(this.q, Y(this, "Will abort after " + this.$a + "ms if incomplete")), this.ea = Wb.setTimeout(B(this.Ca, this), this.$a)), X(this.q, Y(this, "Sending request")), this.Na = l, this.g.send(a), this.Na = r
  }catch(k) {
    X(this.q, Y(this, "Send error: " + k.message)), pd(this, k)
  }
};
u.vb = function() {
  return this.ua ? zb(this.ua) : zb(xb)
};
u.Ca = function() {
  "undefined" != typeof ca && this.g && (this.p = "Timed out after " + this.$a + "ms, aborting", this.ka = qc, X(this.q, Y(this, this.p)), this.dispatchEvent("timeout"), this.abort(qc))
};
function pd(a, b) {
  a.R = r;
...
u.Ob = function() {
  !this.lb && !this.Na && !this.ba ? this.sc() : sd(this)
};
u.sc = function() {
  sd(this)
};
        ...
        if(a.dispatchEvent("readystatechange"), 4 == U(a)) {
          ...
          try {
            ...
            if(!(c = d)) {
              var f;
              if(f = 0 === b) {
                var g = String(a.Pa).match(Ra)[1] || m;
                if(!g && self.location) {
...
function Y(a, b) {
  return b + " [" + a.Jb + " " + a.Pa + " " + nc(a) + "]"
}
;function td() {
  this.Vb = C()
}
new td;
td.prototype.set = t("Vb");
td.prototype.reset = function() {
  this.set(C())
};
td.prototype.get = aa("Vb");
...
function zd(a) {
  ...
  M(b);
  ud(b.toString(), 5E3, B(a.ic, a), 3, 2E3);
  a.F(mc)
}
u.ic = function(a) {
  if(a) {
  ...
  if(this.z.I) {
    if(0 == this.c) {
      ...
      if(2 == this.c) {
        ...
        var a = r;
        (a = hc() ? this.Ua : 200 > this.mb - this.Ka ? r : l) ? (this.a.debug("Test connection succeeded; using streaming connection"), V(Id), Jd(this.b, this, l)) : (this.a.debug("Test connection failed; not using streaming"), V(Ld), Jd(this.b, this, r))
      }
    }
  }else {
...
u.gb = function(a, b, c, d, f) {
  ...
  Vd(this) && (this.T = new wd(this, this.a), this.T.X(this.v), this.T.Zb(this.O), this.T.gb(a))
};
u.disconnect = function() {
  this.a.debug("disconnect()");
  Wd(this);
  if(3 == this.c) {
    var a = this.za++, b = this.La.n();
    K(b, "SID", this.Y);
    K(b, "RID", a);
    K(b, "TYPE", "terminate");
    Xd(this, b);
...
u.Zb = t("O");
function ae(a) {
  !a.o && !a.D && (a.D = W(B(a.Rb, a), 0), a.U = 0)
}
u.Rb = function(a) {
  this.D = m;
...
function be(a) {
  ...
  6 < a.ga && 0 < b ? (d = a.s[0].Lb, c.push("ofs=" + d)) : d = 0;
  for(var f = 0;f < b;f++) {
    var g = a.s[f].Lb, k = a.s[f].map, g = 6 >= a.ga ? f : g - d;
    try {
      cb(k, function(a, b) {
...
function de(a) {
  !a.k && !a.L && (a.sb = 1, a.L = W(B(a.Qb, a), 0), a.fa = 0)
}
function ee(a) {
  if(a.k || a.L) {
...
u.Pb = function(a, b) {
  if(!(0 == this.c || this.k != a && this.o != a)) {
    if(this.h = a.h, this.o == a && 3 == this.c) {
      if(7 < this.ga) {
        ...
        if(x(c) && 3 == c.length) {
          ...
          if(0 == f[0]) {
              ...
              if(this.a.debug("Server claims our backchannel is missing."), this.L) {
                ...
                if(this.k) {
                  if(this.k.oa + 3E3 < this.o.oa) {
                    Zd(this), this.k.cancel(), this.k = m
                  }else {
                    break a
                  }
                }else {
            ...
            this.Kb = f[1], c = this.Kb - this.xa, 0 < c && (f = f[2], this.a.debug(f + " bytes (in " + c + " arrays) are outstanding on the BackChannel"), 37500 > f && (this.qb && 0 == this.fa) && !this.aa && (this.aa = W(B(this.rc, this), 6E3)))
          }
        }else {
      ...
      if(this.k == a && Zd(this), !/^[\s\xa0]*$/.test(b)) {
        c = this.O.parse(b);
...
u.correctHostPrefix = function(a) {
  return this.fc ? this.e ? this.e.correctHostPrefix(a) : a : m
};
u.rc = function() {
  ...
  if(0 != this.c) {
    if(a.I) {
      ...
      if(3 == c || 7 == c || 0 == c && 0 < this.h) {
        ...
        var d;
        if(d = 1 == b) {
          this.o || this.D ? (this.a.H("Request already in progress"), d = r) : this.c == Pd || this.U >= (this.Ja ? 0 : this.jb) ? d = r : (this.a.debug("Going to retry POST"), this.D = W(B(this.Rb, this, a), fe(this, this.U)), this.U++, d = l)
        }
        if(d || 2 == b && ee(this)) {
          return
        }
...
u.Ha = function(a) {
  a && !this.Za && e(Error("Can't create secondary domain capable XhrIo object."));
  a = new nd;
  a.cc = this.Za;
  return a
};
...
$ = function(a, b) {
  ...
  k = function() {
    ...
    c("onconnecting");
    clearTimeout(n);
    p = new Od(b.appVersion, g != m ? g.Cb : h);
    b.crossDomainXhr && (p.Za = l);
    p.e = d;
    f = m;
    if(b.failFast) {
      var k = p;
  ...
  this.close = function() {
    ...
    f = 0;
    if(y.readyState !== $.CLOSED) {
      return v($.cb), p.disconnect()
    }
  };
  this.sendMap = function(a) {
    var b;
    ((b = y.readyState) === $.cb || b === $.CLOSED) && e(Error("Cannot send to a closed connection"));
    b = p;
...
var Image, XMLHttpRequest, ke, le, window;
ke = require("request");
Image = function() {
  var a = this;
  this.__defineSetter__("src", function(b) {
    ...
    return ke(b, function(b) {
      return b != m ? "function" === typeof a.onerror ? a.onerror() : h : "function" === typeof a.onload ? a.onload() : h
    })
  });
  return this
};
...
w = window = {setTimeout:setTimeout, clearTimeout:clearTimeout, setInterval:setInterval, clearInterval:clearInterval, console:console, location:m, navigator:{userAgent:"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_2) AppleWebKit/535.1 (KHTML, like Gecko) Chrome/14.0.835.202 Safari/535.1"}};
le = require("url");
exports.setDefaultLocation = function(a) {
  "string" === typeof a && (a = le.parse(a));
