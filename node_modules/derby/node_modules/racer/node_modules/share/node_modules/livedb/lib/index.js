...
var EventEmitter, Readable, arraydiff, assert, deepEquals, isError, ot, redisLib,
  __slice = [].slice;
...
exports.client = function(snapshotDb, redis, redisObserver, extraDbs) {
  var client, getDocOpChannel, getOpLogKey, nextStreamId, prefixChannel, redisSubmit, streams, subscribeCounts;
  ...
  streams = {};
  nextStreamId = 0;
  if (redisObserver && redisObserver.constructor === Object) {
