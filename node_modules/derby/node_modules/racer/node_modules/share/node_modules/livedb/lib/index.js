  ...
  return client = {
    ...
    */
    ...
    queryFetch: function(cName, query, opts, callback) {
      ...
      return db.query(this, cName, query, function(err, results) {
        if (err) {
          return callback(err);
    ...
    query: function(index, query, opts, callback) {
      ...
      return this._subscribeChannels(channels, function(err, stream) {
        ...
        return db.query(_this, index, query, function(err, results) {
          ...
          (f = function() {
            ...
            while (d = stream.read()) {
              _results.push((function(d) {
                ...
                if (modifies === void 0) {
                  if (poll) {
                    return db.query(client, index, query, function(err, newResults) {
